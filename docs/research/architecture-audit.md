...
|---|---|---|
| `reorderProviders` | `src/lib/registry.ts:81-102` | Only `test/registry.test.ts:4` imports it; no route or UI reorders entries. |
...
| `report_entries` table | `src/db/schema.sql:139-145` | Written by the pass (`src/lib/pass.ts:215-231`) and reseal (`src/index.ts:547`); never read by production code. Timeline rendering uses research lines (`src/lib/reports.ts:152-163`). |
